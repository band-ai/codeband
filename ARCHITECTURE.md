...
|-----|---------|----------------|
| `max_review_rounds` | 6 | `review_failed → in_progress` rework cycles — bounds a productive loop the Watchdog's stall cap never catches (each round commits real code) |
